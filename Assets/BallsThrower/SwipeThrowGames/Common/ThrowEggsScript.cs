...
public class ThrowEggsScript : MonoBehaviour
{
    ...
    void Start()
    {
        _spawnPoint = EggsGameManager.Instance.spawn_transform;
    ...
    void OffScreen(Vector3 cursor_pos)
    {
        ...
        { // Protect from infinite speed throw
            ...
            //Debug.Log("y value " + -pointer_direction.y);
            ...
            Vector3 vector = (_spawnPoint.forward * force_z) + new Vector3(0, -pointer_direction.y/2, 0) ; // Calc throw vector
            ...
            Destroy(this, auto_destroy_timer); // Destroy this script to prevent controlling etc.
        }
    }
